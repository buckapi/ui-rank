...
export class GlobalService {
  // pagesArray: number[] = [];
  private categoriesUrl = 'https://db.buckapi.com:8095/api/collections/category/records';
  private infoUrl = 'https://db.buckapi.com:8095/api/collections/info/records';
  private assetmentsUrl = 'https://db.buckapi.com:8095/api/collections/assetments/records';
  aside=true;
  products: any[] = [];
